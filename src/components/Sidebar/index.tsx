              ...
              <>
                <div>
                  ...
                  <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    {/* <!-- Recruiter Master starts --> */}
                    <SidebarLinkGroup
                      activeCondition={
                        pathname === '/recruiter-master' ||
                        pathname.includes('recruiter-master')
                      }
                    >
                      {(handleClick, open) => {
                        return (
                    ...
                    {/* <!-- Recruiter Master Ends --> */}

                    {/* <!-- Client Master Starts --> */}
                    <SidebarLinkGroup
                      activeCondition={
                        pathname === '/client-master' ||
                        pathname.includes('client-master')
                      }
                    >
                      {(handleClick, open) => {
                        return (
                          <React.Fragment>
                            ...
                            >
                              <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                  <NavLink
                                    to="/client-master/add-new-client"
                                    className={({ isActive }) =>
                                      'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                      (isActive && '!text-white')
                                    }
                    ...
                    {/* <!-- Posting Master Starts --> */}
                    <SidebarLinkGroup
                      activeCondition={
                        pathname === '/posting-master' ||
                        pathname.includes('posting-master')
                      }
                    >
                      {(handleClick, open) => {
                        return (
                          <React.Fragment>
                            ...
                            >
                              <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                ...
                                <li>
                                  <NavLink
                                    to="/posting-master/view-portals"
                                    className={({ isActive }) =>
                                      'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                      (isActive && '!text-white')
                                    }
                          ...
                          <React.Fragment>
                            ...
                            >
                              <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                  <NavLink
                                    to="/general-settings/my-profile"
                                    className={({ isActive }) =>
                                      'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                      (isActive && '!text-white')
                                    }
                                ...
                                <li>
                                  <NavLink
                                    to="/general-settings/interview-status-list"
                                    className={({ isActive }) =>
                                      'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                      (isActive && '!text-white')
                                    }
                                ...
                                <li>
                                  <NavLink
                                    to="/general-settings/drop-reason-list"
                                    className={({ isActive }) =>
                                      'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                      (isActive && '!text-white')
                                    }
              ...
              <>
                <div>
                  ...
                  <ul className="mb-6 flex flex-col gap-1.5">
                    ...
                    <SidebarLinkGroup
                      activeCondition={
                        pathname === '/recruiter/interview-alignment' ||
                        pathname.includes('recruiter/interview-alignment')
                      }
                    >
                      {(handleClick, open) => {
                        return (
                          <React.Fragment>
                            <NavLink
                              to="#"
                              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                (pathname === '/interview-alignment' ||
                                  pathname.includes('interview-alignment')) &&
                                'bg-graydark dark:bg-meta-4'
                              }`}
                              onClick={(e) => {
                                e.preventDefault();
                            ...
                            >
                              <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                  <NavLink
                                    to="/recruiter/interview-alignment/add-candidate"
                                    className={({ isActive }) =>
                                      'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                      (isActive && '!text-white')
                                    }
                    ...
                    <SidebarLinkGroup
                      activeCondition={
                        ...
                        pathname.includes('candidate-status')
                      }
                    >
                      {(handleClick, open) => {
                        return (
                          <React.Fragment>
                            <NavLink
                              to="#"
                              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                (pathname === '/recruiter/client-master' ||
                                  pathname.includes(
                                    'recruiter/client-master',
                                  )) &&
                                'bg-graydark dark:bg-meta-4'
                              }`}
                              onClick={(e) => {
                            ...
                            >
                              <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                ...
                                <li>
                                  <NavLink
                                    to="/recruiter/candidate-status/joining-status"
                                    className={({ isActive }) =>
                                      'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ' +
                                      (isActive && '!text-white')
                                    }
